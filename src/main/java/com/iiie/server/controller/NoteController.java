...
public class NoteController {
    ...
    public SuccessResponse<Void> addNote(
            @PathVariable Long careGiverId,
            @PathVariable Long guardianId,
            @RequestBody NoteDTO.NoteRequest noteRequest) {
        Note note = noteService.addNote(careGiverId, guardianId, noteRequset.getNoteContent());
        NoteDTO.NoteResponse noteResponse = convertToNoteResponse(note);
